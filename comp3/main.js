...
function myFunction() {
    document.getElementById("demo").innerHTML="We just initialized a JSON variable named 'myJson' " +
    "setting the value equal to a JSON object obtained from https://github.com/ozlerhakan/mongodb-json-files/blob/master/datasets/books.json" +
...
function getTitle() {    
    document.getElementById("demo2").innerHTML=myJson.title;
}
function getIsbn() {    
    document.getElementById("demo3").innerHTML=myJson.isbn;
}
function getDescription() {    
    document.getElementById("demo4").innerHTML=myJson.shortDescription;
}

var makeString = JSON.stringify(myJson);
function stringifyMe(){
    document.getElementById("demo5").innerHTML=makeString;
}

//var newJSON = '{"name":"John", "age":31, "city":"New York"}';
var makeParse = JSON.parse(makeString);
function parseMe(){   
    document.getElementById("demo6").innerHTML="The 'typeof' function for the parsed variable is " +typeof(makeParse);
}